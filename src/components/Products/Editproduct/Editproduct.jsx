...
const Editproduct = () => {
  return (
    <div className='bg-gray-100 min-h-screen w-full md:ml-60 px-5'>
      ...
      {/* form box */}
        <div className="bg-white rounded-md w-full md:w-[80%]  p-5 shadow-lg">
                ...
                <div className="w-full max-w-3xl rounded-xl shadow-md py-8 px-3 bg-white border-1 border-gray-200">
                    ...
                    <form className="flex flex-col p-2 md:p-6 w-full">
                        <div className='flex flex-col md:flex-row gap-3 mb-4 w-full'>
                            <div className='flex flex-col gap-1 w-[100%] md:w-1/2'>
