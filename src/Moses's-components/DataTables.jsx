...
export const DataTables = () => {
	return (
		<section className='flex justify-center flex-col items-start max-w-[72.625rem] bg-surface-white rounded-[0.5rem] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.15)] font-Lato shrink-0 md:ml-60'>
